...
class TestSortem < Minitest::Test
  ...
  def test_that_same_users_are_filtered
    same_user_set = [
      ["Sys1", "User", 1234, "text", "extra_text"],
      ["Sys2", "User", 1234, "text", "extra_text"],
      ["Sys3", "User", 1234, "text", "extra_text"],
    ]

    same_users_filtered = Sortem.new(same_user_set).result('name', 'ein')
  ...
  def test_that_different_users_are_filtered
    ...
    different_users_filterd = Sortem.new(different_user_set).result('name', 'ein')
  ...
  def test_that_partially_matching_users_kept
    polluted_user_set = [
      ["Sys1", "User", 4567, "text", "extra_text"],
      ["Sys2", "User", 1234, "text", "extra_text"],
    ]
    polluted_users_filtered = Sortem.new(polluted_user_set).result('name', 'ein')
  ...
  def test_that_multiple_partially_matching_users_kept
    polluted_user_set = [
      ["Sys2", "User", 1234, "text", "extra_text"],
      ["Sys1", "Uzer", 1234, "text", "extra_text"],
      ["Sys3", "User", 1234, "text", "extra_text"],
    ]
    polluted_users_filtered = Sortem.new(polluted_user_set).result('name', 'ein')
